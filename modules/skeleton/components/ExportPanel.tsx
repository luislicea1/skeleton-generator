...
import { FRAMEWORKS, type SvgData, type Framework, type Theme, type AnimationType } from '../types/skeleton';
...
export default function ExportPanel({ svgData, animation, duration, theme }: ExportPanelProps) {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-2">
        <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">{t.exportModal.framework}</p>
