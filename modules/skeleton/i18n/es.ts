...
const es: Translations = {
  ...
  uploader: {
    title: 'Imagen PNG o SVG',
    subtitle: 'Sube un archivo PNG o SVG para generar su skeleton.',
    algorithm: 'Algoritmo',
    modePrecise: 'Preciso',
    ...
    dropzoneTitle: 'Arrastra tu PNG o SVG aquí o',
    dropzoneCta: 'selecciona un archivo',
    dropzoneHint: 'Archivos PNG o SVG',
    change: 'Cambiar',
    ...
    errorOnlyPngOrSvg: 'Solo se aceptan archivos PNG o SVG.',
  },
  preview: {
  ...
  container: {
    uploadTitle: 'Imagen PNG o SVG',
    uploadSubtitle: 'Sube un archivo PNG o SVG para generar su skeleton.',
    emptyTitle: 'Esperando tu PNG o SVG…',
    emptySubtitle: 'Sube un archivo PNG o SVG a la izquierda para ver el skeleton animado generado aquí.',
  },
  footer: {
