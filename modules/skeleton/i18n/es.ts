...
const es: Translations = {
  ...
  landing: {
    titleLine1: "Crea Skeletons",
    titleGradient: "animados,",
    titleLine3: "en segundos.",
    subtitle: "Genera skeleton loaders animados desde cualquier diseño. Copia el código y úsalo en tu proyecto.",
