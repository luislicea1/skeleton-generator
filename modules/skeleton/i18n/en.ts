...
const en: Translations = {
  ...
  uploader: {
    title: 'PNG or SVG Image',
    subtitle: 'Upload a PNG or SVG file to generate its skeleton.',
    algorithm: 'Algorithm',
    modePrecise: 'Precise',
    ...
    dropzoneTitle: 'Drag your PNG or SVG here or',
    dropzoneCta: 'select a file',
    dropzoneHint: 'PNG or SVG files only',
    change: 'Change',
    ...
    errorOnlyPngOrSvg: 'Only PNG or SVG files are accepted.',
  },
  preview: {
  ...
  container: {
    uploadTitle: 'PNG or SVG Image',
    uploadSubtitle: 'Upload a PNG or SVG file to generate its skeleton.',
    emptyTitle: 'Waiting for your PNG or SVG…',
    emptySubtitle: 'Upload a PNG or SVG file on the left to see the generated animated skeleton here.',
  },
  footer: {
